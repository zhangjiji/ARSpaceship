...
@synthesize window=window_, navController=navController_, director=director_, overlay=overlay_;
...
//	[window_ setRootViewController:rootViewController_];
    ...
    overlay_ = [[UIView alloc] initWithFrame:[[UIScreen mainScreen] bounds]];
    overlay_.backgroundColor = [UIColor clearColor];
    overlay_.opaque = NO;
    [window_ addSubview:overlay_];
